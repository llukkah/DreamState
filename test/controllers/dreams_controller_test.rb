...
class DreamsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create dream" do
    assert_difference('Dream.count') do
      post dreams_url, params: { dream: { location: @dream.location, story: @dream.story, year: @dream.year } }, as: :json
    end
  ...
  test "should update dream" do
    patch dream_url(@dream), params: { dream: { location: @dream.location, story: @dream.story, year: @dream.year } }, as: :json
    assert_response 200
  end
